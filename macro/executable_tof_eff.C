...
TH1D *tof_eff_calculate(TFile* data,bool IsMC,bool save_plots,int time_bin)
{
	...
	{	
		...
		cout << "Bin: " << i << endl;
		cout << "Eff: " << ToF_Eff->GetBinContent(i) << " Error: " << error <<  endl;
		cout <<"Nsel: " << Nsel <<" Nsel_error: " << Nsel_error << " Nsel_error/Nsel: " << Nsel_error/Nsel << endl; 
		cout <<"Nsam: " << Nsam <<" Nsam_error: " << Nsam_error << " Nsam_error/Nsam: " << Nsam_error/Nsam << endl; 
	}
	return ToF_Eff;	
}
